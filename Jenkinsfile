#!/usr/bin/env groovy
/*
 * semanticcms-dia-bom - Bill of Materials (BOM) for SemanticCMS Dia features.
 * Copyright (C) 2021  AO Industries, Inc.
 *     support@aoindustries.com
 *     7262 Bull Pen Cir
 *     Mobile, AL 36695
 *
 * This file is part of semanticcms-dia-bom.
 *
 * semanticcms-dia-bom is free software: you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * semanticcms-dia-bom is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * GNU Lesser General Public License for more details.
 *
 * You should have received a copy of the GNU Lesser General Public License
 * along with semanticcms-dia-bom.  If not, see <https://www.gnu.org/licenses/>.
 */
...
def upstreamProjects = [
	...
	// BOM
	'all', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-dia-all</artifactId>
